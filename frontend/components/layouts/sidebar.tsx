                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                          <Image className="ml-[5px] w-8 flex-none" width={300} height={300} src="/assets/sidebarlogo.png" alt="logo" />
                          <span className="align-middle text-2xl font-bold lg:inline ml-5">
                            <span className="text-[#0A2F5C]">Stack</span>
                            <span className="text-[#2FA84F]">POS</span>
                           </span>
